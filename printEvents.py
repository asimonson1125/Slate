...
events = recurring_ical_events.of(calendar).between(datetime.datetime.now(), datetime.datetime.now() + datetime.timedelta(hours=12)) # Gets calendar timeline between now and now+2days as an array
